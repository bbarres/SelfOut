...
#binary variable for presence/absence of coinfection the previous year####
...
OvWi13<-glmer(PA_S2014~coinfYN+AA_F2013+Gdiv+connec2013+cumulative_sum+(1|SIN_86),family=binomial,data=coinf)
summary(OvWi13)
OvWi13<-glmer(PA_S2014~coinfYN+AA_F2013+(1|SIN_86),family=binomial,data=coinf)
summary(OvWi13)
...
op<-par(mfrow=c(1,2))
visreg(OvWi13,"coinfYN",scale="response",overlay=TRUE,
       xlab="No coinf (0)/ coinf (1)",ylab="P(P/A 2014)")
visreg(OvWi13,"AA_F2013",rug=2,scale="response",jitter=TRUE,by="coinfYN",
...
OvWi12<-glmer(PA_S2013~coinfYN+AA_F2012+Gdiv+connec2012+cumulative_sum+(1|SIN_86),family=binomial,data=coinf)
summary(OvWi12) #dropping the non sign factor does not affect significance
OvWi12<-glmer(PA_S2013~coinfYN+AA_F2012+connec2012+(1|SIN_86),family=binomial,data=coinf)
summary(OvWi12) #dropping the non sign factor does not affect significance
...
op<-par(mfrow=c(1,2))
visreg(OvWi12,"coinfYN",scale="response",overlay=TRUE,
       xlab="No coinf (0)/ coinf (1)",ylab="P(P/A 2013)")
visreg(OvWi12,"AA_F2012",rug=2,scale="response",jitter=TRUE,by="coinfYN",
...
#percentage of coinfection the previous year for patches with at least 3 samples####
...
OvWi13<-glmer(PA_S2014~percoinf+AA_F2013+Gdiv+connec2013+cumulative_sum+(1|SIN_86),family=binomial,data=coinf)
summary(OvWi13)
OvWi13<-glmer(PA_S2014~percoinf+AA_F2013+(1|SIN_86),family=binomial,data=coinf)
summary(OvWi13)

OvWi13_1<-glm(PA_S2014~percoinf+AA_F2013,family=binomial,data=coinf)
summary(OvWi13_1)
OvWi13_2<-glm(PA_S2014~AA_F2013,family=binomial,data=coinf)
summary(OvWi13_2)
OvWi13_3<-glm(PA_S2014~percoinf,family=binomial,data=coinf)
summary(OvWi13_3)
anova(OvWi13_2,OvWi13_1,test="Chisq")
summary(OvWi13_1)
...
OvWi12<-glmer(PA_S2013~percoinf+AA_F2012+Gdiv+connec2012+cumulative_sum+(1|SIN_86),family=binomial,data=coinf)
summary(OvWi12)
OvWi12<-glmer(PA_S2013~percoinf+AA_F2012+(1|SIN_86),family=binomial,data=coinf)
summary(OvWi12)

OvWi12_1<-glm(PA_S2013~percoinf+AA_F2012,family=binomial,data=coinf)
summary(OvWi12_1)
OvWi12_2<-glm(PA_S2013~AA_F2012,family=binomial,data=coinf)
summary(OvWi12_2)
OvWi12_3<-glm(PA_S2013~percoinf,family=binomial,data=coinf)
summary(OvWi12_3)
anova(OvWi12_2,OvWi12_1,test="Chisq")
summary(OvWi12_1)
...
chasmo13<-glmer(chasmoYN~coinfYN+AA_F2013+Gdiv+connec2013+cumulative_sum+(1|SIN_86),family=binomial,data=coinf)
summary(chasmo13) 
chasmo13<-glm(chasmoYN~coinfYN+AA_F2013+Gdiv+connec2013+cumulative_sum,family=binomial,data=coinf)
summary(chasmo13)
