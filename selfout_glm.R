...
visreg(modnewgeno_1,"percoinf12",scale="response",lwd=10,font.lab=2,font=2,
       cex.lab=2,cex.axis=2,ann=FALSE,
...
box(bty="l",lwd=4)
axis(1,lwd=3,font=2,cex.axis=2,padj=0.25)
...
rug(jitter(datanewgeno$percoinf12,amount=1),col="violetred",pos=0.068)
par(op)
...
#export to a tiff file 980 x 700 pixels
